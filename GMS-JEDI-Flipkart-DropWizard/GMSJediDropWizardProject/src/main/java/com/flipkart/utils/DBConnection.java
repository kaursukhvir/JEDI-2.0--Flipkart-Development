...
//              String url = "jdbc:mysql://localhost:3306/Flipfit";//flipfit is the name of database 3306 is the port no. of mysql
                FileInputStream inputStream = new FileInputStream("/Users/arsh.d/Desktop/JEDI-2.0-Flipkart-Development/GMS-JEDI-Flipkart-DropWizard/GMSJediDropWizardProject/config.properties");
