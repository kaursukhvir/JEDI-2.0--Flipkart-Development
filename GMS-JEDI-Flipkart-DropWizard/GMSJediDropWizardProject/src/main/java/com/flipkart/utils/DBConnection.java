...
//              String url = "jdbc:mysql://localhost:3306/Flipfit";//flipfit is the name of database 3306 is the port no. of mysql
                FileInputStream inputStream = new FileInputStream("/Users/apoorv.singh2/JavaProject/JEDI-2.0-Flipkart-Development/GMS-JEDI-Flipkart-DropWizard/GMSJediDropWizardProject/config.properties");
